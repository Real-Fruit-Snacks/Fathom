...
`g++ <path/to/source.cpp> <-std=<<c++17> <-o> <path/to/output_executable>`
...
`g++ <-c> <path/to/source1.cpp> <path/to/source2.cpp> <path/to/source3.cpp> && g++ <*.o> <-o> <path/to/output_executable>`

- Optimize the compiled program for performance:

`g++ <path/to/source.cpp> <-O1|O2|O3|Os|Ofast> <-o> <path/to/output_executable>`